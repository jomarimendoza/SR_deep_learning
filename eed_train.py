...
# Import Deep model
from models import EED_model, load_data_hdf5
...
def train_from_checkpoint():
    ...
    # create proposed model, with ResNet weights frozen
    model = EED_model(inputs=inputs)
    model.load_weights('checkpoints/eed_weights.h5')
    ...
    model.save_weights('eed_weights.h5')
